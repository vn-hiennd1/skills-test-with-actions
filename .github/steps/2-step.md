...
![An illustration with a left half and a right half. On the left: illustration of how GitHub Actions terms are encapsulated. At the highest level: workflows and event triggers. Inside workflows: jobs and definition of the build environment. Inside jobs: steps. Inside steps: a call to an action. On the right: the evaluated sequence: workflow, job, step, action.](https://github.com/vn-hiennd1/skills-test-with-actions/blob/main/.github/images/github-actions-workflow-diagram.png?raw=true)
...
1. In the left navigation, above list of workflows, click the **New workflow** button.
   ...
   <img width="250" alt="image" src="https://github.com/vn-hiennd1/skills-test-with-actions/blob/main/.github/images/new-workflow-button.png?raw=true" />

1. Enter `python` into the search box and click the **Enter** button.

   <img width="300" alt="search box with 'python' value" src="https://github.com/vn-hiennd1/skills-test-with-actions/blob/main/.github/images/python-search-box.png?raw=true" />

1. Find the **Python package** workflow and click the **Configure** button to open a file editor with a pre-made workflow.

   <img width="250" alt="image" src="https://github.com/vn-hiennd1/skills-test-with-actions/blob/main/.github/images/python-package-configure.png?raw=true" />
...
1. Check the status bar for a pending update. Click it to pull your recently committed workflow.
   ...
   <img width="130" alt="image" src="https://github.com/vn-hiennd1/skills-test-with-actions/blob/main/.github/images/sync-changes-button.png?raw=true" />
